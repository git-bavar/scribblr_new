...
import 'package:scribblr/screens/following_screen.dart';
      ...
      children: [
        ...
        Column(
          children: [
            Text('Elina',
                style:
                    TextStyle(color: appStore.isDarkMode ? scaffoldLightColor : scaffoldDarkColor)),
            8.height,
        ...
        ElevatedButton(
          ...
          child: Row(
            children: [
              Icon(Icons.edit,
                  size: 14, color: appStore.isDarkMode ? scaffoldLightColor : primaryColor),
              Text('Edit',
                  style: TextStyle(color: appStore.isDarkMode ? scaffoldLightColor : primaryColor)),
            ],
          ),
        ),
      ],
    ...
    return Column(
      ...
      children: [
        Text(
          'About',
          style:
              primarytextStyle(color: appStore.isDarkMode ? scaffoldLightColor : scaffoldDarkColor),
        ),
        15.height,
        Text(
          'Description',
