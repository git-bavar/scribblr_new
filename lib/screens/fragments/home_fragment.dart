...
import 'package:scribblr/components/article_widget.dart';
            ...
            Stack(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: Color(0xFFAC7B6B), shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(20)),
                  child: Column(
