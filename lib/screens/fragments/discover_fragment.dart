...
import 'package:scribblr/components/explore_component.dart';
import 'package:scribblr/components/top_writers_component.dart';
import 'package:scribblr/screens/articles.dart';
import 'package:scribblr/screens/top_writers.dart';
import 'package:scribblr/screens/topic_explores.dart';
...
class _DiscoverFragmentState extends State<DiscoverFragment> {
  ...
  List<ArticleModel> getList(String listType) {
    if (listType == articleList)
      return articleList.firstWhere((element) => element.listType == articleList).articleList.validate();
    else if (listType == explore_by_topics)
      return articleList.firstWhere((element) => element.listType == explore_by_topics).articleList.validate();
    else if (listType == top_writers)
      return articleList.firstWhere((element) => element.listType == top_writers).articleList.validate();
    else if (listType == recommendation)
      return articleList.firstWhere((element) => element.listType == recommendation).articleList.validate();
    else if (listType == new_article)
      return articleList.firstWhere((element) => element.listType == new_article).articleList.validate();
    else
      return [];
  }
