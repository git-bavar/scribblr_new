                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DropdownButtonFormField(
                        dropdownColor: appStore.isDarkMode ? Color(0xFF1F222A) : context.scaffoldBackgroundColor,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                        ...
                        hint: Text('Gender', style: TextStyle(color: appStore.isDarkMode ? scaffoldLightColor : scaffoldDarkColor)),
                        value: genderValue?.toLowerCase(),
                        decoration: inputDecoration(context),
                        items: genderItem.map((itemValue) {
                          return DropdownMenuItem(
                            child: Text(itemValue, style: TextStyle(color: appStore.isDarkMode ? scaffoldLightColor : scaffoldDarkColor)),
