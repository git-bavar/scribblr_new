      ...
      return Scaffold(
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text("Create an account 🔐", style: primarytextStyle(color: appStore.isDarkMode ? scaffoldLightColor : scaffoldDarkColor)),
              15.height,
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelStyle: TextStyle(color: appStore.isDarkMode ? scaffoldLightColor : scaffoldDarkColor),
