...
import 'package:scribblr/components/resend_pin.dart';
...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Observer(builder: (context) {
      return Scaffold(
        appBar: AppBar(
          surfaceTintColor: appStore.isDarkMode ? scaffoldDarkColor : scaffoldPrimaryLight,
          iconTheme:
              IconThemeData(color: appStore.isDarkMode ? scaffoldLightColor : scaffoldDarkColor),
          backgroundColor: appStore.isDarkMode ? scaffoldDarkColor : scaffoldPrimaryLight,
        ),
