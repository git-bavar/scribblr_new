...
import 'package:scribblr/components/comment_component.dart';
import 'package:scribblr/components/text_styles.dart';
import 'package:scribblr/screens/comments.dart';
            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(widget.articleData.authorImage.validate()),
                          fit: BoxFit.cover),
                    ),
                  ).paddingSymmetric(horizontal: 16),
                  Column(
                  ...
                  Spacer(),
                  ChipComponent(unselectedText: 'Follow', selectedText: 'Following')
                      .paddingSymmetric(horizontal: 16),
                ],
              ),
              10.height,
