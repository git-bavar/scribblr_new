  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Chip(
        ...
        label: Text(widget.label, style: TextStyle(fontSize: 12, color: _isSelected ? Colors.white : primaryColor)),
        backgroundColor: _isSelected ? primaryColor : context.scaffoldBackgroundColor,
