          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  widget.text,
                  style: secondarytextStyle(color: appStore.isDarkMode ? Colors.white : Colors.black),
                ).expand(),
...
List<Widget> settingComponent(BuildContext context) => [
      ...
      SettingsComponent(icon: appStore.isDarkMode ? Icons.dark_mode_outlined : Icons.dark_mode, color: Colors.black, text: 'Dark Mode', showSwitch: true),
      SettingsComponent(
          icon: Icons.people,
